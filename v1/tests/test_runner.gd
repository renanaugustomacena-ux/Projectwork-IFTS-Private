...
const TEST_MODULES := [
	...
	"res://tests/integration/test_needs.gd",
	"res://tests/integration/test_slots.gd",
	"res://tests/integration/test_seats.gd",
	...
	"res://tests/integration/test_polish.gd",
	"res://tests/integration/test_review.gd",
]
