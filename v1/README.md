...
└── tests/                          # 242 test invasivi + runner headless custom
...
14. **deep-tests** — 242 test via `scripts/deep_test.sh`, gated su smoke; il job invoca
...
./scripts/deep_test.sh           # 242 test in 24 moduli, ~1-2 min (user:// isolato, vedi tests/README)
```
